...
# class MoveRightByCustomSubwordCommand(sublime_plugin.TextCommand):
#     def run(self, edit, extend=False):
#         granular_move(self.view, edit, by='subword', forward=True, extend=extend)


# class MoveLeftByCustomWordCommand(sublime_plugin.TextCommand):
#     def run(self, edit, extend=False):
#         granular_move(self.view, edit, by='word', forward=False, extend=extend)


# class MoveRightByCustomWordCommand(sublime_plugin.TextCommand):
#     def run(self, edit, extend=False):
#         granular_move(self.view, edit, by='word', forward=True, extend=extend)


# class MoveLeftByCustomBigwordCommand(sublime_plugin.TextCommand):
#     def run(self, edit, extend=False):
#         granular_move(self.view, edit, by='bigword', forward=False, extend=extend)


# class MoveRightByCustomBigwordCommand(sublime_plugin.TextCommand):
#     def run(self, edit, extend=False):
#         granular_move(self.view, edit, by='bigword', forward=True, extend=extend)
